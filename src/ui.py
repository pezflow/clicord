...
class UI:
    def __init__(self):
        ...
        self.username_color = "[" + self.theme["username_color"] + "]" 
        self.panel_title_color = "[" + self.theme["panel_title_color"] + "]"
    ...
    def refresh(self):
        self.layout["top"]["guilds"].update(Panel(
            "\n".join(self.guilds),
            title=f"{self.panel_title_color}your servers",
            border_style=self.theme["accent_color"],
            style=self.theme["text_color"]))

        self.layout["top"]["channels"].update(Panel(
            "\n".join(self.channels),
            title=f"{self.panel_title_color}{self.guild_name}",
            border_style=self.theme["accent_color"],
            style=self.theme["text_color"]))
